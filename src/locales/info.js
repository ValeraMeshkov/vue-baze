export default {
  ...
  projectWithOnlineBroadcast: {
    en: 'A project with the creation of an online broadcast + custom chat in it. Using the library (Video.js), working with websocket',
    ru: 'Проект с созданием онлайн трансляции + кастомным чатом в ней. Использование библиотеки (Video.js), работа с websocket',
  },
  neuronForFood: {
    en: 'Processing the data received from the neuron for food recognition and displaying in the interface all the dishes found and their quantity with the price',
    ru: 'Обработка полученных данных с нейронки для распознавания еды и отображение в интерфейсе всех найденных блюд и их кол-во с ценой',
  },
  differentWorks: {
    en: 'Working with calendars loaded with spreadsheets (lazy loading), pagination, authorization through social networks, creation of custom galleries, animations, etc...',
    ru: 'Работа c календарями, загруженными таблицами (с ленивой загрузкой), пагинация, авторизация через соцсети, создание кастомных галерей, анимаций и тд...',
  },
  interfaceSupport: {
    en: 'Interface support for different browsers Chrome, Safari, Mozilla Firefox, Edge. Display on different devices with different resolutions.',
    ru: 'Поддержка интерфейса для разных браузеров Chrome, Safari, Mozilla Firefox, Edge. Отображение на разных устройствах с разным разрешением.',
  },
  architectureOfProjects: {
